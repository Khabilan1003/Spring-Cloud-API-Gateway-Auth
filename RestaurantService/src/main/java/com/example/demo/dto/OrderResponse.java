...
public class OrderResponse {
	...
	public OrderResponse(String orderId, String name, int qty, double price, Date orderDate, String status,
	...
	public String toString() {
		return "OrderResponse [orderId=" + orderId + ", name=" + name + ", qty=" + qty + ", price=" + price
